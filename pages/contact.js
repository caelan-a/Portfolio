...
export default function ContactPage({ }) {
    ...
    return (
        <Layout>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-center motion-safe:animate-fadeIn h-screen w-full">
                <div class="md:flex flex-col md:flex-row  items-center justify-center h-full w-full "style={{ backgroundColor: "#C2D6DB" }}>
                    <div class="hidden md:flex flex-col lg:w-1/4 space-y-10 items-center justify-center pt-20 h-full" >
                        <img class="inline-block w-2/5 lg:w-1/2 rounded-full ring-8 ring-white " src="/assets/images/profile.jpg" alt="" />
                    ...
                    <div class="flex flex-col lg:w-3/4 space-y-10  px-20 py-10 h-full shadow-lg" style={{ backgroundColor: "white" }}>
                        <div className="">
